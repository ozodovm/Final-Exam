    ...
    return (
        <>
            ...
            <div
                ...
                className="col-span-1 w-full rounded-lg overflow-hidden relative"
            >
                <div
                ...
                {hover && (
                    <div className="absolute top-[210px] inset-x-0 mx-auto flex items-center justify-center space-x-[10px]">
                        <button
                            style={{ color: product.basket ? "#46A358" : "" }}
                            onClick={() => basketMutation.mutate()}
                            className={`p-1 bg-white rounded-lg ${product.basket ? "text-[#46A358]" : "text-[#3D3D3D]"}`}
                        >
                            <BasketIcon />
                        </button>
                        <button
                            style={{ color: product.liked ? "red" : "" }}
                            onClick={() => mutationLike.mutate()}
                            className={`p-1 bg-white rounded-lg ${product.liked ? "text-red-500" : "text-[#3D3D3D]"}`}
                        >
                            <LikeIcon />
                        </button>
                    </div>
