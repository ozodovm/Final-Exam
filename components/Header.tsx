...
import Register from '../components/authintification/Register';
import Verify from '../components/authintification/Verify';
import Login from '../components/authintification/Login';
        ...
        <>
            ...
            <Modal openModal={openLoginModal} setOpenModal={setOpenLoginModal} extraStyle='w-[500px]'>
                ...
                <form onSubmit={handleSubmit} className='w-[300px] mx-auto space-y-5'>
                    {selectedAuth == "login" && <Login onReset={handleReset} />}
